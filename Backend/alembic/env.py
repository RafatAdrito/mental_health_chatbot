...
# Use the asyncpg URL directly — this is what the rest of the app already uses
ASYNC_URL = settings.database_url  # postgresql+asyncpg://...
# Alembic offline mode needs a plain dialect URL (no async driver prefix)
OFFLINE_URL = ASYNC_URL.replace("postgresql+asyncpg://", "postgresql://")
...
def include_object(object, name, type_, reflected, compare_to):
    """Exclude LangGraph-managed tables from autogenerate diffs."""
